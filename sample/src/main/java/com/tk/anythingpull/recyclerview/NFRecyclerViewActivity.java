 ...
 */
public class NFRecyclerViewActivity extends AppCompatActivity {
    @Bind(R.id.toolbar)
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recyclerview_nf);
        ...
        recyclerview.addOnItemTouchListener(new OnRecyclerClickListener(recyclerview) {
            ...
            public void onClick(int position) {
                Toast.makeText(NFRecyclerViewActivity.this, "点击了" + position, Toast.LENGTH_SHORT).show();
            }
        });
    }
