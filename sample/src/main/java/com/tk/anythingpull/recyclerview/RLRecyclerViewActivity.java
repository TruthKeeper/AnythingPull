 ...
 */
public class RLRecyclerViewActivity extends AppCompatActivity {
    @Bind(R.id.toolbar)
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recyclerview_rl);
        ...
        recyclerview.addOnItemTouchListener(new OnRecyclerClickListener(recyclerview) {
            ...
            public void onClick(int position) {
                Toast.makeText(RLRecyclerViewActivity.this, "点击了" + position, Toast.LENGTH_SHORT).show();
            }
        });
